...
export interface CreateHandlerOptions {
  ...
  onHealthCheck?: (req: VercelRequest) => Promise<any>
}
...
export class ApolloServer extends ApolloServerBase {
  createGraphQLServerOptions(req: VercelRequest, res: VercelResponse): Promise<GraphQLOptions> {
    ...
    return async (req: VercelRequest, res: VercelResponse) => {
      ...
      const fileUploadHandler = async (next: Function) => {
        ...
        if (
          ...
          try {
            req.body = await processRequest(req, res, this.uploadsConfig || {})
